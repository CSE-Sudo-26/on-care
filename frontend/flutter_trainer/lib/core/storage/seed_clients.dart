  ...
  _Client(
    ...
    history: <_History>[
      _History(
        ...
        label: 'AI 개인운동',
        completionRate: 100,
        exercises: <String>['인터벌 런닝 25분 ✓', '스쿼트 3세트 · 12회 · 40kg ✓', '플랭크 3세트 · 3회 ✓'],
      ...
      _History(
        ...
        label: 'PT 세션 · 트레이너 지도',
        completionRate: 100,
        exercises: <String>['데드리프트 3세트 · 8회 · 55kg', '런지 3세트 · 12회 · 10kg', '코어 서킷 2세트 · 12회'],
  ...
  _Client(
    ...
    history: <_History>[
      _History(
        ...
        label: 'PT 세션 · 트레이너 지도',
        completionRate: 100,
        exercises: <String>['벤치프레스 4세트 · 8회 · 65kg', '인클라인 덤벨 3세트 · 10회 · 26kg', '트라이셉스 딥 3세트 · 12회'],
  ...
  _Client(
    ...
    history: <_History>[
      _History(
        ...
        label: 'AI 개인운동',
        completionRate: 100,
        exercises: <String>['걷기 25분 ✓', '골반 안정화 15분 ✓', '밴드 로우 3세트 · 15회 ✓'],
  ...
  _Client(
    ...
    history: <_History>[
      _History(
        ...
        label: 'AI 개인운동',
        completionRate: 100,
        exercises: <String>['LSD 러닝 45분 ✓', '힙 힌지 3세트 · 12회 ✓', '스트레칭 10분 ✓'],
      ...
      _History(
        ...
        label: 'AI 개인운동',
        completionRate: 100,
        exercises: <String>['인터벌 러닝 30분 ✓', '코어 서킷 3세트 · 12회 ✓', '스트레칭 ✓'],
  ...
  _Client(
    ...
    history: <_History>[
      ...
      _History(
        ...
        label: 'AI 개인운동',
        completionRate: 100,
        exercises: <String>['전신 서킷 4세트 · 12회 ✓', '걷기 30분 ✓', '스트레칭 10분 ✓'],
  ...
  _Client(
    ...
    history: <_History>[
      _History(
        ...
        label: 'AI 개인운동',
        completionRate: 100,
        exercises: <String>['걷기 20분 ✓', '맨몸 스쿼트 3세트 · 15회 ✓', '스트레칭 10분 ✓'],
