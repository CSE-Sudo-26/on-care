...
const List<_Client> _clients = <_Client>[
  _Client(
    ...
    chat: <_Chat>[
      ...
      _Chat('client', '화요일이랑 목요일이 야근이 많아요 😥', '화 10:15', dayIndex: 0),
      _Chat(
        'trainer',
      ...
      _Chat('client', '그 정도면 퇴근하고도 할 수 있을 것 같아요', '화 10:24', dayIndex: 0),
      _Chat(
        'trainer',
      ...
      _Chat('client', '네, 아침 8시 그대로예요', '화 10:29', dayIndex: 0),
      _Chat(
        'trainer',
