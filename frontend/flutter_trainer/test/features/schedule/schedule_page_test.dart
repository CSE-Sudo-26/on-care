...
void main() {
  ...
  group('SchedulePage', () {
    ...
    testWidgets('주간 시간표에 시간축·격자·세션 블록이 함께 그려진다 (#988)', (tester) async {
      ...
      expect(find.text('17\u201317:30 30분'), findsOneWidget);
      ...
      expect(find.text('윤가온(신규) 상담'), findsWidgets);
    ...
    testWidgets('일정 수정 moves 박성호 to a 15-minute step (15:00 → 15:30)', (
      ...
      expect(find.text('15\u201316 60분'), findsNothing);
    });
    ...
    testWidgets('프로그램 수정 edits exercises and memo inside the card', (
      ...
      expect(find.text('15\u201316 60분'), findsOneWidget);
